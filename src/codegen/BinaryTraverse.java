...
public class BinaryTraverse extends BaseTraverse {
    ...
    public Object traverse(AstNode root) {
        ...
        switch (production) {
            ...
            case SyntaxProductionInit.Binary_Start_Binary_TO_Binary:
                ...
                BaseTraverse.resultOnStack = true;
                ...
                if (production == SyntaxProductionInit.Binary_Plus_Binary_TO_Binary) {
                    ...
                    Generator.getInstance().emit(Instruction.IADD);
                    ...
                    root.setAttribute(NodeKey.TEXT, text);
                    ConsoleDebugColor.outlnPurple(text + " is " + (val1 - val2));
                    Generator.getInstance().emit(Instruction.ISUB);
                    ...
                    Generator.getInstance().emit(Instruction.IMUL);
                } else {
                    root.setAttribute(NodeKey.VALUE, val1 / val2);
                    ...
                    Generator.getInstance().emit(Instruction.IDIV);
                }
            ...
            case SyntaxProductionInit.Binary_RelOP_Binary_TO_Binray:
                //check null before convert to integer
                ...
                String branch = Generator.getInstance().getCurrentBranch() + "\n";
