	...
	private enum LoopType {
	 ...
	 public Object generate(AstNode root) {
		 ...
		 case SyntaxProductionInit.FOR_OptExpr_Test_EndOptExpr_Statement_TO_Statement:
			 ...
			 while(BaseGenerate.isCompileMode == false && isLoopContinute(root, LoopType.FOR)) {
		 ...
		 case SyntaxProductionInit.While_LP_Test_Rp_TO_Statement:
			 ...
			 while (BaseGenerate.isCompileMode == false && isLoopContinute(root, LoopType.WHILE)) {
				 executeChild(root, 1);
			 }
			 break;
